...
#  Last change: $Date: 2016-01-21 10:51:35 +0100 (jeu. 21 janv. 2016) $
...
SRC     = src
INC     = -I. -I../driver
FILES   = $(SRC)/libpcanbasic_legacy.cpp
DBG     = -g
RT      = NO_RT
...
.PHONY: message
message:
	@ echo "*** Making lib PCANBasic WITHOUT FD support (PCAN driver <8.0)"
	@ echo "***"
	@ echo "***"
	@ echo "*** target=$(LDNAME)"
