...
enum {
	...
	PCANFD_OPT_AVAILABLE_CLOCKS,		/* superseeds */
	PCANFD_OPT_BITTIMING_RANGES,		/* deprecated */
...
#define PCANFD_FEATURE_FD		0x0000001
#define PCANFD_FEATURE_IFRAME_DELAYUS	0x0000002
#define PCANFD_FEATURE_BUSLOAD		0x0000004
#define PCANFD_FEATURE_HWTIMESTAMP	0x0000008
